 ...
 *  OAuthLoginFlow and touching splice.app.auth.OAuthAccountFiles both live in :app; :daemon-control
 ...
 *  `Map<String, ManagedHead>` — the same reason [splice.control.api.fleet.HeadRoutes] calls
