...
description: >-
  Check if code complexity flows properly. Good code has a gradient: sparse
  setup → building logic → dense core → clean resolution (jo-ha-kyū). Code
  that's equally dense everywhere has no gradient and is exhausting to read.
  Use when code feels messy but you can't say why, or during readability
  review. Triggers: "this function is hard to read", "how should I organize
  this", "this feels messy", or "/readability-flow".
user-invocable: true
context:
