...
description: >-
  Map information density across functions, files, or modules. Find walls
  (H≈0, pure boilerplate) and impenetrable blocks (H=max, doing too many
  things). Optimal code has moderate entropy with clear gradients. Use for
  code review, finding what to delete, or locating the load-bearing logic.
  Triggers: "is this too complex", "where should I focus my review", "what
  can I delete", "is this boilerplate", or "/complexity-scan".
user-invocable: true
context:
