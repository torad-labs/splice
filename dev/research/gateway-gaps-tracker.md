...
| G17 | Proactive refresh blocks request path | two-tier: async prefetch above stale floor, blocking below | done (kimi) 99c3316, (grok) 8a470f4 — codex (G6's blocking-only proactive refresh) still pending |
