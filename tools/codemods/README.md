...
## Run
    ...
    npx ast-grep scan --rule tools/codemods/<name>.yml <paths>            # DRY RUN — shows diffs, changes nothing
    npx ast-grep scan --rule tools/codemods/<name>.yml <paths> --update-all   # APPLY
