#!/usr/bin/env bun
/** tools/e2e/fixtures/mcp_overlong_tool_server.ts — a REAL minimal stdio MCP server for the heads e2e.
 *
...
import { dumps, loads, obj, objGet, isPyObj, fromJS, quote, type PyValue, type PyObj } from "../src/compat/python-json.ts";
