...
name: prompt-audit
description: >-
  This skill should be used when the user asks to "audit this prompt",
  "improve my prompt", "check for overlapping directives", "review my skill",
  "fix my prompts", "prompt audit", or wants to apply the rejection framework
  to any prompt, skill, agent definition, or instruction set.
user-invocable: true
argument-hint: "[path to SKILL.md, prompt file, or paste inline]"
---
...
Build the prompt from the template in [`references/phase-find.md`](references/phase-find.md). Inline the full target prompt/skill content. Haiku extracts directives, maps dimensions, detects same-dimension overlaps, runs the cross-dimensional intersection test, checks verifiability, and flags over/under-constraint.
...
Build the prompt from [`references/phase-fix.md`](references/phase-fix.md). Pass the original prompt AND the full Phase 1 output. If the target is a SKILL.md, also pass the best practices reference from [`references/best-practices.md`](references/best-practices.md).
...
Build the prompt from [`references/phase-leverage.md`](references/phase-leverage.md). Pass ALL three artifacts: original prompt, Phase 1 analysis, Phase 2 revision.
...
- [`references/best-practices.md`](references/best-practices.md) — Anthropic skill guidelines
- [`references/phase-find.md`](references/phase-find.md) — Haiku prompt template
- [`references/phase-fix.md`](references/phase-fix.md) — Sonnet prompt template
- [`references/phase-leverage.md`](references/phase-leverage.md) — Opus prompt template
