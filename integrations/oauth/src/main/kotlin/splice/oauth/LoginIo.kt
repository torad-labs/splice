...
// through [TerminalOutput] (LAYOUT-01); the terminal-and-install half is app's cli/auth/CliSignIn.kt.
...
public data class LoginAnnouncement(
    public val userCode: String? = null,
    public val verificationUri: String? = null,
    public val browserUrl: String? = null,
)
