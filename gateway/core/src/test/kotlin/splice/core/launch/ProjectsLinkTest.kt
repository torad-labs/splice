// NEW: V4-64's cells for the merge-then-link (2026-09-16), re-landed by V4-168 (2026-09-19) after
// V4-115 had replaced ProjectsLink with an un-link and these cells with its own. The class under
// test is the same reviewed implementation; the two policy cells at the top are the contract the
// operator's splice.toml exercises (share names projects -> the link; isolate names it -> private).
