...
// collaborators) moved into splice.head.round because they are a self-contained state machine
...
// splice.head.turn.DrivePorts.kt: their consumers (WsRoundDriver, RequestMaterializationGate)
