...
internal class AccountPoolText(private val now: WallClock = WallClock { System.currentTimeMillis() }) {

    /** `on work (1 of 2 open) · 5h 12% · 7d 40%; switched primary -> work 3m ago: 7d window exhausted` */
    fun summary(view: HeadAccountPoolView): String {
    ...
    fun check(headKey: String, view: HeadAccountPoolView): DoctorCheck {
        val safe = safeView(view)
