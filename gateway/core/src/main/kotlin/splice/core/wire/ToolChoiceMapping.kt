...
// Named object since the 2026-08-16 style migration (HD-M8): the mapper crosses two wire vocabularies
// and belongs to neither ToolChoice nor JsonElement. Same name, same body, same JSON.
...
public object ToolChoiceMapping {
