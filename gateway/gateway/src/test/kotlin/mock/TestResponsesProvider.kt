// NEW: test-local concrete ResponsesProvider so :gateway tests do not construct CodexProvider
...
//
// TestResponsesQuirks is deliberately independent of CodexQuirks: :gateway must not depend on
// provider-codex. This profile starts at the bare ResponsesQuirks constructor and carries only
// fields :gateway:test load-bears on. It does not stand in for Codex's live profile.
package mock
