...
//
// Usage: node dev/web-console/lib/fixtures.mjs          check the table against the pages
//        node dev/web-console/lib/fixtures.mjs --json   the same, as JSON
import { readFileSync, readdirSync, statSync } from 'node:fs';
import { join, resolve } from 'node:path';

const ROOT = resolve(import.meta.dirname, '../../..');
const PAGES = join(ROOT, 'webui/src/pages');
