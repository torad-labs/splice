...
name: coupling-test
description: >-
  Test whether a dependency between modules is real (load-bearing) or decorative
  (removable without changing behavior). Measures entanglement strength across
  belief change, trust, vulnerability, and interface impedance. Use when pruning
  dependencies, deciding what to mock, or refactoring module boundaries.
  Triggers: "is this dependency necessary", "should I mock this", "are these
  modules really coupled", or "/coupling-test".
user-invocable: true
context:
