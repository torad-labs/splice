...
dependencies {
    ...
    api(project(":features-lifecycle"))
    api(project(":features-diagnostics"))
    api(project(":features-models"))
    api(project(":features-launch"))
    api(project(":features-configuration"))
