...
val moduleLaw: Map<String, Set<String>> = mapOf(
    ...
    ":integrations-dialects-openai-chat" to setOf(":core", ":upstream"),
    ":integrations-providers-codex" to setOf(":core", ":upstream", ":integrations-dialects-openai-responses"),
    ":integrations-providers-grok" to setOf(":core", ":upstream", ":integrations-dialects-openai-responses"),
