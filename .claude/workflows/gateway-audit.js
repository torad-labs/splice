...
const CONTEXT = `
You are auditing the Kotlin gateway of the splice repo at /Users/user/dev/infra/splice.
...
cd /Users/user/dev/infra/splice/gateway && JAVA_HOME=/opt/homebrew/opt/openjdk@21/libexec/openjdk.jdk/Contents/Home ./gradlew check --console=plain
