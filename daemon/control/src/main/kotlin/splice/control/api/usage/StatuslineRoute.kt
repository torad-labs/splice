...
// (the constant there is file-private to :upstream, which :daemon-control does not depend on).
 ...
 *  SseSpuriousWakeupException) because :daemon-control depends on :core alone, and reaching for that type
