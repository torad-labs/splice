...
/**
 * The first of [keys] that reads as a number, or null — THE usage-alias chain (CX-18).
 *
 ...
 */
public fun JsonObject.firstLong(vararg keys: String): Long? =
    keys.firstNotNullOfOrNull { key ->
        this[key].str()?.toDoubleOrNull()?.toLong()
    }
