...
// policy, not public), the same shape splice.core.teams.TeamStore already uses for a small
...
public class BudgetStore(private val file: Path) {
     ...
     *  replaced by an empty list, the same law [splice.core.teams.TeamStore] keeps. */
