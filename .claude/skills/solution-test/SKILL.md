...
name: solution-test
description: >-
  Test whether a solution is stable under pressure by generating independent
  approaches and checking convergence. If they all converge to the same design,
  it's a strong attractor. If they diverge, the problem has multiple valid
  solutions and you need to choose deliberately. Use before committing to major
  design decisions. Triggers: "is this the right architecture", "will this hold
  up", "what if we're wrong", or "/solution-test".
user-invocable: true
context:
